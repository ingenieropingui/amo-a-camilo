...
titulo_label = ttk.Label(window, text="Registro de Usuarios", font=("Franklin Gothic Medium Cond", 16), background='#053B50')
nombre_label = ttk.Label(window, text="Nombre:",font=("Corbel",12), background='#053B50')
email_label = ttk.Label(window, text="Email:",font=("Corbel",12), background='#053B50')
id_label = ttk.Label(window, text="ID:",font=("Corbel",12), background='#053B50')
telefono_label = ttk.Label(window, text="Telefono:",font=("Corbel",12), background='#053B50')
...
telefono_label.grid(row=4, column=0, padx=10, pady=5, sticky="e")
telefono_entry.grid(row=4, column=1, padx=10, pady=5, sticky="w")
contrasena_label.grid(row=5, column=0, padx=10, pady=5, sticky="e")
